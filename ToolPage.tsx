           ...
           case 'crop-pdf': {
            ...
            case 'compare-pdf': {
                ...
                for(let i=1; i<=numPages; i++){
                    ...
                    const numDiffPixels = pixelmatch(img1Data.data as Uint8ClampedArray, img2Data.data as Uint8ClampedArray, diffImageData.data as Uint8ClampedArray, width, height, { threshold: 0.1, includeAA: true });
